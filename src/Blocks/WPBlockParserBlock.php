...
class WP_Block_Parser_Frame {
     ...
     * @since 5.0.0
     *
     * @param WPBlockParserBlock $block              Full or partial block.
...
class WP_Block_Parser {
        ...
        switch ( $token_type ) {
            ...
            case 'void-block':
                ...
                if ( 0 === $stack_depth ) {
                    ...
                    $this->output[] = (array) new WPBlockParserBlock( $block_name, $attrs, array(), '', array() );
                ...
                $this->add_inner_block(
                    new WPBlockParserBlock( $block_name, $attrs, array(), '', array() ),
                    $start_offset,
                    $token_length
                );
                $this->offset = $start_offset + $token_length;
    ...
    function freeform( $innerHTML ) {
        return new WPBlockParserBlock( null, $this->empty_attrs, array(), $innerHTML, array( $innerHTML ) );
    }
     ...
     */
    function add_inner_block( WPBlockParserBlock $block, $token_start, $token_length, $last_offset = null ) {
